...
Release  : 24
URL      : https://www.thrysoee.dk/editline/libedit-20240517-3.1.tar.gz
Source0  : https://www.thrysoee.dk/editline/libedit-20240517-3.1.tar.gz
...
%prep
%setup -q -n libedit-20240517-3.1
cd %{_builddir}/libedit-20240517-3.1
pushd ..
cp -a libedit-20240517-3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716088259
...
cp %{_builddir}/libedit-20240517-3.1/COPYING %{buildroot}/usr/share/package-licenses/libedit/23d54f3ac85bc67716a2591c090796b0937433eb || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libedit.so.0.0.73
/usr/lib64/libedit.so.0
/usr/lib64/libedit.so.0.0.73
