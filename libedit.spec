...
Source0  : https://www.thrysoee.dk/editline/libedit-20210216-3.1.tar.gz
...
%prep
%setup -q -n libedit-20210216-3.1
cd %{_builddir}/libedit-20210216-3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613515378
...
cp %{_builddir}/libedit-20210216-3.1/COPYING %{buildroot}/usr/share/package-licenses/libedit/23d54f3ac85bc67716a2591c090796b0937433eb
%make_install
